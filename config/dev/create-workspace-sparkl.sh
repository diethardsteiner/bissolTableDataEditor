...
export PROJECT_SETTINGS=/home/dsteiner/Dropbox/projects/bissolTableDataEditor/config/dev/set-project-variables.sh
source $PROJECT_SETTINGS

gnome-terminal --tab --title biserver --working-directory /home/dsteiner/apps/pentaho/biserver/biserver-ce-5.1.0 --tab --title sql --working-directory=/home/dsteiner/apps/sqlworkbench --tab --title pdi --working-directory /home/dsteiner/apps/pentaho/pdi/pdi-ce-5.1.0.0 --tab --title git --working-directory /home/dsteiner/Dropbox/projects/bissolTableDataEditor --tab --title netbeans --working-directory /home/dsteiner/apps/netbeans-8.0/bin --execute ./netbeans
